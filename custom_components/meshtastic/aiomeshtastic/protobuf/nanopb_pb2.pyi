...
Global___IntSize: _TypeAlias = IntSize  # noqa: Y015
...
"""Replace the package name by the initials"""
Global___TypenameMangling: _TypeAlias = TypenameMangling  # noqa: Y015
...
"""8 words; up to 2^32-1 entry arrays"""
Global___DescriptorSize: _TypeAlias = DescriptorSize  # noqa: Y015
...
class NanoPBOptions(_message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        long_names: _builtins.bool | None = ...,
        packed_struct: _builtins.bool | None = ...,
        packed_enum: _builtins.bool | None = ...,
        skip_message: _builtins.bool | None = ...,
        no_unions: _builtins.bool | None = ...,
        msgid: _builtins.int | None = ...,
        anonymous_oneof: _builtins.bool | None = ...,
        proto3: _builtins.bool | None = ...,
        proto3_singular_msgs: _builtins.bool | None = ...,
        enum_to_string: _builtins.bool | None = ...,
        fixed_length: _builtins.bool | None = ...,
        fixed_count: _builtins.bool | None = ...,
        submsg_callback: _builtins.bool | None = ...,
        mangle_names: Global___TypenameMangling.ValueType | None = ...,
        callback_datatype: _builtins.str | None = ...,
        callback_function: _builtins.str | None = ...,
        descriptorsize: Global___DescriptorSize.ValueType | None = ...,
        default_has: _builtins.bool | None = ...,
        include: _abc.Iterable[_builtins.str] | None = ...,
        exclude: _abc.Iterable[_builtins.str] | None = ...,
        package: _builtins.str | None = ...,
        type_override: _descriptor_pb2.FieldDescriptorProto.Type.ValueType | None = ...,
        sort_by_tag: _builtins.bool | None = ...,
